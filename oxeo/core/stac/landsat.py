...
from .ang_metadata import AngMetadata
from .assets import ANG_ASSET_DEF, COMMON_ASSET_DEFS, SR_ASSET_DEFS, THERMAL_ASSET_DEFS
from .constants import Sensor  # yapf: disable
...
from .fragments import CollectionFragments, Fragments
from .mtl_metadata import MtlMetadata
from .utils import get_usgs_geometry, handle_antimeridian
...
def create_stac_item(
    ...
    mtl_metadata = MtlMetadata(mtl_xml_href, legacy_l8=legacy_l8)
    ...
    if geometry is None:
        if sensor is Sensor.OLI_TIRS:
            ...
            ang_metadata = AngMetadata(ang_href)
